...
![consul-nodes](./img/s2e14-consul-nodes.PNG "consul-nodes")

![prometheus-targets](./img/s2e14-prometheus-targets.PNG "prometheus-targets")

![prometheus-metrics](./img/s2e14-prometheus-metrics.PNG "prometheus-metrics")
